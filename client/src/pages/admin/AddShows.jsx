...
const AddShows = () => {
    ...
    const handleDateTimeAdd = () => {
        if (!showDateInput || !showTimeInput) {
            return toast.error('Please select both date and time');
        }
        const date = showDateInput;
       ...
       <div className="mt-8">
        ...
        <div className="mt-6">
            ...
            <div className="inline-flex gap-5 border border-gray-600 p-1 pl-3 rounded-lg">
                <input type="date" value={showDateInput} onChange={(e) => setShowDateInput(e.target.value)} className="outline-none rounded-md" />
                <input type="time" value={showTimeInput} onChange={(e) => setShowTimeInput(e.target.value)} className="outline-none rounded-md" />
